...
( function( $ ) {
    ...
    $(document).ready( function() {
        window.tpc_metabox_addon = new tpc_metabox_addon({});
    });

    function tpc_metabox_addon() {
        var that = this;

        that.set_tabs = tpc_metabox_tab;
        that.set_dependancy = tpc_metaboxio_dependancy;
    ...
    */
    ...
    function tpc_metaboxio_dependancy($a) {
