...
if (!class_exists('Corpix_Theme_Dependencies')) {
    /**
     ...
     * @since 1.0.0
     */
    class Corpix_Theme_Dependencies
    {
        ...
        public static function include_theme_essential_files()
        {
            ...
            if (is_admin()) {
              ...
              //  require get_template_directory() . '/admin/envato_setup/envato_notice.php';
            }

            /**
             * One click demo import.
             */
            require get_theme_file_path('admin/tpc-demo-import.php');
