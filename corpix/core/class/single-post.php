...
if (!class_exists('Corpix_Single_Post')) {
    /**
     * @package corpix\core\class
     * @author Pixelcurve <help.pixelcurve@gmail.com>
     * @since 1.0.0
     */
    class Corpix_Single_Post
    {
        /**
         * @var Corpix_Single_Post
         */
            ...
            if (class_exists('RWMB_Loader')) {
                switch ($this->post_format) {
                    case 'gallery':
                        ...
                        break;
                    case 'video':
                        global $tpc_related_posts;
                        if (is_singular('post') && empty($tpc_related_posts)) {
                            $this->meta_info_render = false;
                        } else {
                            $this->meta_info_render = true;
                        }
                        ...
                        if (has_post_thumbnail()) {
                            if (!is_single() || !empty($tpc_related_posts)) {
                        ...
                        if (is_string($this->media) && strpos($this->media, 'rwmb-oembed-not-available', 11) !== false) {
                            $this->media = false;
                        }
                        break;
                    case 'quote':
        ...
        public function render_featured_image_as_background(
            ...
            $featured_image = Corpix::get_mb_option('featured_image_type', 'mb_featured_image_conditional', 'custom');
            if ('replace' === $featured_image) {
                $featured_image_replace = Corpix::get_mb_option('featured_image_replace', 'mb_featured_image_conditional', 'custom');
            }
            ...
            if ($media && $show_media) {
                ...
                $default_bg = Corpix::get_option('post_single_layout_3_bg_image');
            ...
            if (
                ...
                if ('bg_video' == $video_style) {
                    ...
                    if (has_post_thumbnail()) {
                        ...
                        $output .= '<div class="tpc-video_popup with_image">';
        ...
        public function featured_gallery($image_size)
        {
            ...
            // Render
            ob_start();
            echo '<div class="slider-wrapper tpc-carousel prev_next_pos_right">';
                echo '<div class="blog-post_media-slider_slick tpc-carousel_slick fade_slick">';
        ...
        public function render_post_meta($args = false)
        {
            ...
            if ($this->show_meta_shares && function_exists('tpc_theme_helper')) {
                tpc_theme_helper()->render_post_list_share();
            }
            ...
            if (
                ...
                if ($this->show_meta_author) {
                    echo '<span class="post_author"><i class="flaticon-user-2"></i><span>',
                ...
                if ($this->show_meta_date && has_post_thumbnail() ) { ?>
                    ...
                    <div class="blog-top-meta-date">
                        <span class="blog-day-month"><span><?php echo esc_html($archive_day); ?></span><?php echo esc_html($archive_month); ?></span>
                    </div>
              <?php  }

                elseif($this->show_meta_date && !has_post_thumbnail()) {

                    echo '<span class="post_date_not_thumb"> <i class="flaticon-calendar"></i>';
                        echo get_the_date();
                    echo '</span>';
                ...
                if ($this->show_meta_comments) {
                    ...
                    echo '<span class="comments_post"> <i class="flaticon-chat"></i>',
                        '<a href="', esc_url(get_comments_link()), '" title="', esc_attr__('Leave a reply', 'corpix'), '">',
                            esc_html($comments_num),
                            ' ',
                            esc_html(_n('Comment', 'Comments', $comments_num, 'corpix')),
                        '</a>',
                    '</span>';
                }
        ...
        public function render_post_meta_02($args = false)
        {
            $this->set_post_meta($args);
            ...
            if (
               ...
               // if ($this->show_meta_date) { ?>
                    <span class="post_date"><i class="flaticon-calendar"></i><span>
                        <?php echo get_the_date(); ?>
                    </span></span>
              <?php // }
        ...
        public function render_excerpt(
            ...
            if ($trim || Corpix::get_option('blog_post_listing_content')) {
                ...
                $post_content = Corpix::modifier_character($content_strip_tags, $symbol_count, '...');
            }
        ...
        public function get_post_views($postID, $grid = false)
        {
            ...
            $title = __('Total Views', 'corpix');

            return '<span class="post_views tpc-views" title="' . esc_attr($title) . '">'
                . '<span class="counter"><i class="far fa-eye"></i>'
                    . esc_html($counter)
                    . ' '
                    . '<span class="views_text">'.esc_html(_n('View', 'Views', (int) $counter, 'corpix')) . '</span>'
                . '</span>'
            . '</span>';
        }
        ...
        public function set_post_views($postID)
        {
            ...
            $user_ip = function_exists('tpc_get_ip') ? tpc_get_ip() : '0.0.0.0';
        ...
        public function render_author_info()
        {
            ...
            $social_medias = '';
            if (function_exists('tpc_user_social_medias_arr')) {
                foreach (tpc_user_social_medias_arr() as $social => $value) if (get_the_author_meta($social)) {
                    $social_medias .= '<a'
