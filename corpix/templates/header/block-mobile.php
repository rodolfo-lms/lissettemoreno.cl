...
if (!class_exists('Corpix_Header_Mobile')) {
    class Corpix_Header_Mobile extends Corpix_Get_Header
    {
        public function __construct()
        {
            ...
            $header_mobile_background = Corpix_Theme_Helper::get_option('mobile_background');
            $header_mobile_color = Corpix_Theme_Helper::get_option('mobile_color');
            $mobile_header_custom =  Corpix_Theme_Helper::get_option('mobile_header');
            $mobile_sticky = Corpix_Theme_Helper::get_option('mobile_sticky');
        ...
        { ?>
            ...
            <div class="tpc-header-row_wrapper">
                ...
                <div class="header_side display_grow h_align_right">
                    <div class="header_area_container"><?php
                        echo Corpix_Theme_Helper::render_html($this->search('mobile', '', 'mobile')); ?>
                    </div>
                </div>
            </div>
            </div>
