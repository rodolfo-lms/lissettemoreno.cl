...
if (!class_exists('Corpix_Get_Header')) {
    class Corpix_Get_Header
    {
        ...
        public function header_vars()
        {
            ...
            * @since 1.0.0
            */
            $this->header_type = Corpix_Theme_Helper::get_option('header_type');

            if ($this->header_type === 'custom') {

                $header_page_select = Corpix_Theme_Helper::get_option('header_page_select');
            ...
            */
            ...
            if (Corpix_Theme_Helper::get_mb_option('header_sticky', 'mb_customize_header_layout', 'custom') == '1') {
                $header_sticky_page_select = Corpix_Theme_Helper::get_option('header_sticky_page_select');
        ...
        {
            $header_shadow = Corpix_Theme_Helper::get_option('header_shadow');
            $header_on_bg = Corpix_Theme_Helper::get_option('header_on_bg');
            $header_class = '';
        ...
        public function header_bar_editor($location = null, $position = null)
        {
            ...
            */
            ...
            ${'header_'.$position.'_editor'} = Corpix_Theme_Helper::get_option($location.'_header_bar_'.$position.'_editor');
        ...
        public function header_bar_delimiter($k = null)
        {
            ...
            */
            ...
            $height = Corpix_Theme_Helper::get_option('bottom_header_delimiter'.$get_number.'_height');
            $width = Corpix_Theme_Helper::get_option('bottom_header_delimiter'.$get_number.'_width');

            $bg_color = Corpix_Theme_Helper::get_option('bottom_header_delimiter'.$get_number.'_bg');

            $margin = Corpix_Theme_Helper::get_option('bottom_header_delimiter'.$get_number.'_margin');
            ...
            if ($this->html_render === 'sticky') {
                $custom_sticky = Corpix_Theme_Helper::get_option('bottom_header_delimiter'.$get_number.'_sticky_custom');
                if (!empty($custom_sticky)) {
                    $bg_color = Corpix_Theme_Helper::get_option('bottom_header_delimiter'.$get_number.'_sticky_color');
                    $height  = Corpix_Theme_Helper::get_option('bottom_header_delimiter'.$get_number.'_sticky_height');
                }
            }
        ...
        public function header_bar_button($k = null)
        {
            ...
            $get_number = (int) filter_var($k, FILTER_SANITIZE_NUMBER_INT);
            $button_text = Corpix_Theme_Helper::get_option('bottom_header_button'.$get_number.'_title');

            $link = Corpix_Theme_Helper::get_option('bottom_header_button'.$get_number.'_link');
            $target = Corpix_Theme_Helper::get_option('bottom_header_button'.$get_number.'_target');

            $size = Corpix_Theme_Helper::get_option('bottom_header_button'.$get_number.'_size') ?? 'md';

            $customize = Corpix_Theme_Helper::get_option('bottom_header_button'.$get_number.'_custom');
            $customize = empty($customize) ? 'def' : 'color';

            $text_color_idle = Corpix_Theme_Helper::get_option('bottom_header_button'.$get_number.'_color_txt')['rgba'] ?? '';
            $text_color_hover = Corpix_Theme_Helper::get_option('bottom_header_button'.$get_number.'_hover_color_txt')['rgba'] ?? '';

            $border_color = Corpix_Theme_Helper::get_option('bottom_header_button'.$get_number.'_border')['rgba'] ?? '';
            $border_color_hover = Corpix_Theme_Helper::get_option('bottom_header_button'.$get_number.'_hover_border')['rgba'] ?? '';
            $border_radius = Corpix_Theme_Helper::get_option('bottom_header_button'.$get_number.'_radius') ?? false;

            $bg_color = Corpix_Theme_Helper::get_option('bottom_header_button'.$get_number.'_bg')['rgba'] ?? '';
            $bg_color_hover = Corpix_Theme_Helper::get_option('bottom_header_button'.$get_number.'_hover_bg')['rgba'] ?? '';

            $button_css_id = uniqid('corpix_button_');
            ...
            // Register css
            if ($styles) Corpix_Theme_Helper::enqueue_css($styles);
            ...
            $this->add_render_attribute('button', 'class', 'tpc-button');
        ...
        public function get_render_attribute_string($element)
        {
            ...
            return ' ' . Corpix_Theme_Helper::render_html_attributes( $this->render_attributes[ $element ] );
        }
        ...
        */
        public function header_bar_spacer($location = null, $key = null)
        {
            ...
            $spacer = Corpix_Theme_Helper::get_option($location.'_header_spacer'.$get_number);
        ...
        {
            $header_layout = Corpix_Theme_Helper::get_option($section . '_header_layout');
            $lavalamp_active = Corpix_Theme_Helper::get_option('lavalamp_active');
            ...
            for ($i = 1; $i <= $counter; $i++) {
                ...
                if (!empty($header_layout) && $has_element) {
                    switch ($section) {
                                ...
                                if (
                                    ...
                                    foreach ($header_layout[$part] as $key => $value) if ($key != 'placebo') {
                                        switch ($key) {
                                            ...
                                            case 'menu':
                                                $menu = 'main_menu';
                                                if (Corpix_Theme_Helper::get_option('custom_mobile_menu')) {
                                                    $custom_menu = true;
                                                    $menu = Corpix_Theme_Helper::get_option('mobile_menu');
                                                }
                                                if (
                                                    class_exists('RWMB_Loader')
                                                    && $this->id !== 0
                        ...
                        default:
                            echo '<div class="tpc-header-row tpc-header-row-section', esc_attr($location), '"', $this->row_style_color($location, $section), '>';
                            echo '<div class="', esc_attr($this->row_width_class($location, $section)), '">';
                            echo '<div class="tpc-header-row_wrapper"', $this->row_style_height($location, $section), '>';
                            ...
                            echo '</div>';
                            echo '</div>';
                            echo '</div>'; // tpc-header-row tpc-header-row-section
                        break;
                    }
                    $has_element = false;
                }
        ...
        */
        private function row_width_class($s = '_middle', $section = '')
        {
            ...
            switch ($section) {
                case 'bottom':
                    $width_container = Corpix_Theme_Helper::get_option('header'.$s.'_full_width');
                    break;
                case 'sticky':
                    $width_container = Corpix_Theme_Helper::get_option('header_custom_sticky_full_width');
                    break;
                case 'mobile':
                    $width_container = Corpix_Theme_Helper::get_option('header_mobile_full_width');
                    break;
            }

            return $width_container ? 'fullwidth-wrapper' : 'tpc-container';
        }
        ...
        private function row_style_color($s = '_middle')
        {
            ...
            switch ($this->html_render) {
                case 'bottom':
                case 'sticky':
                    $header_background = Corpix_Theme_Helper::get_option('header'.$s.'_background');
                    $header_bg_image = Corpix_Theme_Helper::get_option('header'.$s.'_background_image')['url'] ?? '';

                    $header_color = Corpix_Theme_Helper::get_option('header'.$s.'_color');
                    $header_bottom_border = Corpix_Theme_Helper::get_option('header'.$s.'_bottom_border');
                    $header_border_height = Corpix_Theme_Helper::get_option('header'.$s.'_border_height')['height'] ?? '';
                    $header_bottom_border_color = Corpix_Theme_Helper::get_option('header'.$s.'_bottom_border_color');
                    ...
                    $customize_width = Corpix_Theme_Helper::get_option('header'.$s.'_max_width_custom');

                    if ($customize_width == '1') {
                        $max_width = Corpix_Theme_Helper::get_option('header'.$s.'_max_width');
        ...
        */
        ...
        {
            $header_mobile_height = Corpix_Theme_Helper::get_option('header_mobile_height')['height'] ?? false;
            $header_height = Corpix_Theme_Helper::get_option('header'.$s.'_height')['height'] ?? false;
        ...
        {
            $icon_bg = Corpix_Theme_Helper::get_option('bottom_header_side_panel_background')['rgba'] ?? '';
            $icon_color = Corpix_Theme_Helper::get_option('bottom_header_side_panel_color')['rgba'] ?? '';
        ...
        {
            $dispay = Corpix_Theme_Helper::get_option('header_column' . $s . '_' . $area . '_display');
            $v_align = Corpix_Theme_Helper::get_option('header_column' . $s . '_' . $area . '_vert');
            $h_align = Corpix_Theme_Helper::get_option('header_column' . $s . '_' . $area . '_horz');
        ...
        {
            $header_queries = Corpix_Theme_Helper::get_option('header_mobile_queris');
            ...
            $mobile_header_custom = Corpix_Theme_Helper::get_option('mobile_header');
            $menu_occurrence = $mobile_header_custom ? Corpix_Theme_Helper::get_option('mobile_position') : '';

            echo "<div class='mobile_nav_wrapper' data-mobile-width='$header_queries'>";
            echo '<div class="container-wrapper">';
                echo '<div class="tpc-menu_overlay"></div>';

                echo '<div class="tpc-menu_outer tpc-perfect-container',
                    ($menu_occurrence ? ' menu-position_'.esc_attr($menu_occurrence) : ''), '">';

                    echo '<div class="tpc-menu-outer_header">',
                    ...
                    echo '<div class="tpc-menu-outer_content">';
        ...
        public function header_render_html()
        {
            ...
            echo '<header class="tpc-theme-header', esc_attr($this->header_class()), '">';

                // Default header
                echo '<div class="tpc-site-header', (!empty($mobile_header_custom) ? ' mobile_header_custom' : ''), '">';
                    echo '<div class="container-wrapper">';
        ...
        public function get_logo($menu_condition = false, $_prefix = '')
        {
            ...
            new Corpix_Get_Logo($location, $menu_condition, $logo ?? '', $custom_size ?? '');
        }
        ...
        {
            $description = esc_html__('Type To Search', 'corpix');
            $search_style = Corpix_Theme_Helper::get_option('search_style') ?: 'standard';
            ...
            $customize = Corpix_Theme_Helper::get_option('bottom_header_item_search_custom');
            $customize = empty($customize) ? 'def' : 'color';

            $text_color = Corpix_Theme_Helper::get_option('bottom_header_item_search_color_txt')['rgba'] ?? '';
            $text_color_hover = Corpix_Theme_Helper::get_option('bottom_header_item_search_hover_color_txt')['rgba'] ?? '';

            $search_css_id = uniqid('corpix_search_');
            ...
            // Register css
            if (!empty($styles)) {
                Corpix_Theme_Helper::enqueue_css($styles);
            }
                    ...
                    echo '<div class="header_search-field">';
                        if ($search_style === 'alt') {
                            echo '<div class="header_search-wrap">',
                                '<div class="corpix_module_double_headings">',
                                    '<h3 class="header_search-heading_description heading_title">',
                                        apply_filters('corpix/search/description', $description),
                                    '</h3>',
                                '</div>',
                                '<div class="header_search-close flaticon-close"></div>',
                            '</div>';
        ...
        */
        ...
        public function login_in($location, $section)
        {
            ...
            echo "<div class='login-in woocommerce'", $this->row_style_height($location, $section), '>';
                ...
                if (is_user_logged_in()) {
                    echo "<a class='login-in_link-logout' href='", esc_url($link_logout), "'>", esc_html__('WC LOGOUT', 'corpix'), "</a>";
                } else {
                    echo "<a class='login-in_link' href='", esc_url_raw($url), "'>", esc_html__('WC LOGIN', 'corpix'), '</a>';
                }
        ...
        {
            echo '<div class="tpc-mini-cart_wrapper">',
        ...
        $login_page_url =  Corpix_Theme_Helper::get_option('login_page_url_mobile');
        $join_page_url = Corpix_Theme_Helper::get_option('join_page_url_mobile');
        $login_text = Corpix_Theme_Helper::get_option('login_text_mobile');
        $join_text = Corpix_Theme_Helper::get_option('join_text_mobile');
        $logout_text = Corpix_Theme_Helper::get_option('logout_text_mobile');
       ...
       if (!is_user_logged_in()) :
            ...
            echo '<a class="logout_link_mobile" href="'.wp_logout_url(home_url()).'">',
                $logout_text,
                '</a>';
       endif;
        ...
        {
            $customize = Corpix_Theme_Helper::get_option('bottom_header_cart_custom');
            $customize = empty($customize) ? 'def' : 'color';

            $text_color_idle = Corpix_Theme_Helper::get_option('bottom_header_catpc_color_txt')['rgba'] ?? '';
            $text_color_hover = Corpix_Theme_Helper::get_option('bottom_header_cart_hover_color_txt')['rgba'] ?? '';

            $cart_css_id = uniqid('corpix_woo_');
            ...
            $this->add_render_attribute('cart', 'class', 'tpc-cart woo_icon elementor-cart');
            $this->add_render_attribute('cart', 'role', 'button');
            $this->add_render_attribute('cart', 'title', esc_attr__('Click to open Shopping Cart', 'corpix'));
        ...
        {
            ob_start();
                echo '<div class="tpc-woo_mini_cart">';
        ...
        public static function sign_in_form()
        {
            ...
            if (get_user_meta($current_user->ID, 'corpix_user_just_signed_in')[0] ?? false) {
                $is_user = true;
            ...
            if (isset($is_user)) {
                if (isset($user_name)) {
                    $message = sprintf(esc_html__('Hello, %s!', 'corpix'), trim($user_name));
                    learn_press_display_message($message, 'success');
                }

                delete_metadata('user', $user_id, 'corpix_user_just_signed_in');
            } else {
