 ...
 * @since 1.0.0
 */
$single_post_navagation = Corpix_Theme_Helper::get_option('single_post_navagation');
...
if ($single_post_navagation == true) :

    if ($nextPost || $prevPost ) :

        echo '<section class="corpix-post-navigation">';
        ...
        if (is_a($prevPost, 'WP_Post')
            ...
            echo '<a class="back-nav_page"',
                ' title="', esc_attr__('Back to previous page', 'corpix'), '"',
        ...
        echo '</section>'; // corpix-post-navigation
