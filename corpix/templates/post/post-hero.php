...
$trim = true;
if (!$tpc_blog_atts) {
    $opt_likes = Corpix_Theme_Helper::get_option('blog_list_likes');
    $opt_share = Corpix_Theme_Helper::get_option('blog_list_share');
    $opt_meta_author = Corpix_Theme_Helper::get_option('blog_list_meta_author');
    $opt_meta_comments = Corpix_Theme_Helper::get_option('blog_list_meta_comments');
    $opt_meta_categories = Corpix_Theme_Helper::get_option('blog_list_meta_categories');
    $opt_meta_date = Corpix_Theme_Helper::get_option('blog_list_meta_date');
    $opt_read_more = Corpix_Theme_Helper::get_option('blog_list_read_more');
    ...
    $tpc_blog_atts = [
        ...
        'blog_layout' => 'grid',
        // Content
        'blog_columns' => Corpix_Theme_Helper::get_option('blog_list_columns') ?: '12',
        'hide_media' => Corpix_Theme_Helper::get_option('blog_list_hide_media'),
        'hide_content' => Corpix_Theme_Helper::get_option('blog_list_hide_content'),
        'hide_blog_title' => Corpix_Theme_Helper::get_option('blog_list_hide_title'),
        'hide_all_meta' => Corpix_Theme_Helper::get_option('blog_list_meta'),
        ...
        'content_letter_count' => Corpix_Theme_Helper::get_option('blog_list_letter_count') ?: '85',
...
while ($query->have_posts()) : $query->the_post();
    ...
    ?>
    <div class="blog-post <?php echo esc_attr($blog_item_classes); ?>"<?php echo Corpix_Theme_Helper::render_html($blog_attr);?>>
                ...
                <?php
                    ...
                    <div class='blog-post-hero_meta-desc'>
                        <?php
                            ...
                            // Render shares
                            if (!(bool)$hide_share && function_exists('tpc_theme_helper') ) :
                                echo rt_theme_helper()->render_post_list_share();
                            endif;

                            if (!(bool)$hide_likes && function_exists('tpc_simple_likes')) {
                                lmsmtpc_simple_likes()->likes_button( get_the_ID(), 0 );
                            }
                ...
                <div class="blog-post-hero_content">
                    ...
                    <div class='blog-post-hero_meta-desc'>
                        <?php
                            ...
                            if (!(bool)$hide_likes && function_exists('tpc_simple_likes')) {
                                lmsmatpc_simple_likes()->likes_button( get_the_ID(), 0 );
                            }
