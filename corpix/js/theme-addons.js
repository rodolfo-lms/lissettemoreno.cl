"use strict";
// Toggle/Accordion
function corpix_accordion_init() {
...
// Accordion Services
function corpix_services_accordion_init() {
...
(function($) {
    ...
    function corpix_ajax_query(grid, section, request_data) {
        if (wait_load) return;
        wait_load = true;
    ...
    function corpix_ajax_init(section) {
        offset_items = 0;
        ...
        if (infinity_item.length) {
            ...
            if (jQuery(infinity_item).is_visible()) {
                corpix_ajax_query(grid, section, request_data);
            }
            var lastScrollTop = 0;
...
function corpix_scroll_animation(){
...
function corpix_blog_masonry_init () {
...
// rt Carousel List
function corpix_carousel_slick() {
...
function corpix_circuit_service() {
...
function corpix_countdown_init () {
...
function corpix_dynamic_styles() {
    var style = jQuery('#corpix-footer-inline-css');
 ...
 */
function corpix_slick_navigation_init (){
  jQuery.fn.corpix_slick_navigation = function (){
...
// rt image comparison
function corpix_image_comparison() {
...
// Images Gallery
function corpix_images_gallery() {
...
function corpix_learnpress_helper() {
...
function corpix_message_anim_init() {
    jQuery('body').on('click', '.message_close_button', function (e) {
        jQuery(this).closest('.corpix_module_message_box.closable').slideUp(350);
    });
}

function corpix_mobile_header() {
...
function corpix_page_title_parallax() {
...
function corpix_extended_parallax() {
...
function corpix_portfolio_parallax() {
...
function corpix_parallax_video() {
...
function corpix_particles_custom() {
...
function corpix_particles_image_custom() {
...
// rt Progress Bars
function corpix_progress_bars_init(e) {
...
function corpix_side_panel_init() {
...
function corpix_sticky_sidebar() {
...
function corpix_text_background() {
...
function corpix_init_timeline_appear() {
...
function corpix_woocommerce_helper(){
...
function corpix_woocommerce_login_in() {
...
function corpix_woocommerce_mini_cart(){
